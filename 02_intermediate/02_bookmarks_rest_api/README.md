...
A RESTful API built with FastAPI for managing URL bookmarks. It uses SQLite for persistent local storage, SQLAlchemy as the Object-Relational Mapper (ORM), and Pydantic for strict data validation.
